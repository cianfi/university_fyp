import threading
import dataclasses
from alert_api.models import GrafanaMessage, Alert, AlertAnnotations
...
def ospf_issue_1():
    """This var contains NETCONF reply where OSPF neighbor link has been shut down"""
    var = {'ospf-oper-data': {'@xmlns': 'http://cisco.com/ns/yang/Cisco-IOS-XE-ospf-oper', 'ospf-state': {'op-mode': 'ospf-ships-in-the-night', 'ospf-instance': {'af': 'address-family-ipv4', 'router-id': '101058049', 'ospf-area': {'area-id': '0', 'ospf-interface': {'name': 'GigabitEthernet2', 'network-type': 'ospf-broadcast', 'passive': 'false', 'demand-circuit': 'false', 'multi-area': {'multi-area-id': '0', 'cost': '0'}, 'node-flag': 'false', 'fast-reroute': {'candidate-disabled': 'false', 'enabled': 'false', 'remote-lfa-enabled': 'false'}, 'cost': '1', 'hello-interval': '10', 'dead-interval': '40', 'retransmit-interval': '5', 'transmit-delay': '1', 'mtu-ignore': 'false', 'lls': 'false', 'prefix-suppression': 'false', 'bfd': 'false', 'ttl-security': {'enabled': 'false', 'hops': '255'}, 'enable': 'true', 'authentication': {'no-auth': '1'}, 'state': 'Down', 'hello-timer': '0', 'wait-timer': '40', 'dr': '0.0.0.0', 'bdr': '0.0.0.0', 'priority': '0'}}, 'process-id': '1'}}, 'ospfv2-instance': {'instance-id': '1', 'vrf-name': None, 'router-id': '101058049', 'ospfv2-area': {'area-id': '0', 'ospfv2-lsdb-area': [{'lsa-type': '1', 'lsa-id': '101058049', 'advertising-router': '101058049', 'lsa-age': '0', 'lsa-options': None, 'lsa-seq-number': '2147483860', 'lsa-checksum': '31948', 'lsa-length': '24', 'router-lsa': {'router-lsa-bits': None, 'router-lsa-number-links': '0'}}, {'lsa-type': '1', 'lsa-id': '134744065', 'advertising-router': '134744065', 'lsa-age': '1', 'lsa-options': None, 'lsa-seq-number': '2147483855', 'lsa-checksum': '5311', 'lsa-length': '36', 'ospfv2-router-lsa-links': {'link-type': '2', 'link-id': '1684300802', 'link-data': '1684300802'}, 'router-lsa': {'router-lsa-bits': None, 'router-lsa-number-links': '1'}}, {'lsa-type': '2', 'lsa-id': '1684300802', 'advertising-router': '134744065', 'lsa-age': '1', 'lsa-options': None, 'lsa-seq-number': '2147483725', 'lsa-checksum': '44494', 'lsa-length': '32', 'network-lsa': {'network-lsa-mask': '4294967292'}}], 'ospfv2-interface': {'name': 'GigabitEthernet2', 'network-type': 'ospf-broadcast', 'enable': 'true', 'passive': 'false', 'demand-circuit': 'false', 'mtu-ignore': 'false', 'prefix-suppresion': 'false', 'cost': '1', 'hello-interval': '10', 'dead-interval': '40', 'retransmit-interval': '5', 'transmit-delay': '1', 'hello-timer': '0', 'wait-timer': '40000', 'dr': '0', 'bdr': '0', 'dr-ip': '0.0.0.0', 'bdr-ip': '0.0.0.0', 'state': 'ospfv2-interface-state-down', 'ttl-security-val': {'enable': 'false', 'hops': '255'}, 'auth-val': {'no-auth': '1'}}}}}}
    print(json.dumps(var, indent=4))


def grafana_alert_first():
    Alert(status='firing', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:29:10Z', endsAt='0001-01-01T00:00:00Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4') commonAnnotations={'description': 'There is an issue with ospf for router-1', 'summary': 'OSPF Neighbour Down'} title='[FIRING:1] OSPF State Services (2025-03-11 15:29:10.007192305 +0000 UTC 2025-03-11 21:29:10.007192305 +0000 UTC router-1)' status='firing' state='alerting' message='**Firing**\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:29:10.007192305 +0000 UTC\n - _stop = 2025-03-11 21:29:10.007192305 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A29%3A10.007192305+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A29%3A10.007192305+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n'
    print(Alert.status)

def grafana_alert_issue_done():
    alerts=[Alert(status='resolved', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:29:10Z', endsAt='2025-03-11T21:30:10Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4'), Alert(status='resolved', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:29:40Z', endsAt='2025-03-11T21:30:40Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4'), Alert(status='resolved', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:32:10Z', endsAt='2025-03-11T21:32:30Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4'), Alert(status='resolved', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:32:20Z', endsAt='2025-03-11T21:32:40Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4'), Alert(status='resolved', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:32:30Z', endsAt='2025-03-11T21:32:50Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4'), Alert(status='resolved', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:32:40Z', endsAt='2025-03-11T21:33:00Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4'), Alert(status='resolved', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:32:50Z', endsAt='2025-03-11T21:33:10Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4'), Alert(status='resolved', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:33:00Z', endsAt='2025-03-11T21:33:20Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4'), Alert(status='resolved', annotations=AlertAnnotations(summary='OSPF Neighbour Down'), startsAt='2025-03-11T21:33:10Z', endsAt='2025-03-11T21:33:30Z', dashboardURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1', panelURL='http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4')] commonAnnotations={'description': 'There is an issue with ospf for router-1', 'grafana_state_reason': 'MissingSeries', 'summary': 'OSPF Neighbour Down'} title='[RESOLVED] OSPF State Services (router-1)' status='resolved' state='ok' message='**Resolved**\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:29:10.007192305 +0000 UTC\n - _stop = 2025-03-11 21:29:10.007192305 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - grafana_state_reason = MissingSeries\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A29%3A10.007192305+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A29%3A10.007192305+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:29:40.007309388 +0000 UTC\n - _stop = 2025-03-11 21:29:40.007309388 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - grafana_state_reason = MissingSeries\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A29%3A40.007309388+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A29%3A40.007309388+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:32:10.01221518 +0000 UTC\n - _stop = 2025-03-11 21:32:10.01221518 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - grafana_state_reason = MissingSeries\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A32%3A10.01221518+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A32%3A10.01221518+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:32:20.003884045 +0000 UTC\n - _stop = 2025-03-11 21:32:20.003884045 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - grafana_state_reason = MissingSeries\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A32%3A20.003884045+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A32%3A20.003884045+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:32:30.012166925 +0000 UTC\n - _stop = 2025-03-11 21:32:30.012166925 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - grafana_state_reason = MissingSeries\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A32%3A30.012166925+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A32%3A30.012166925+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:32:40.009157722 +0000 UTC\n - _stop = 2025-03-11 21:32:40.009157722 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - grafana_state_reason = MissingSeries\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A32%3A40.009157722+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A32%3A40.009157722+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:32:50.007682379 +0000 UTC\n - _stop = 2025-03-11 21:32:50.007682379 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - grafana_state_reason = MissingSeries\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A32%3A50.007682379+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A32%3A50.007682379+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:33:00.007199259 +0000 UTC\n - _stop = 2025-03-11 21:33:00.007199259 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - grafana_state_reason = MissingSeries\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A33%3A00.007199259+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A33%3A00.007199259+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n\nValue: B=0, C=1\nLabels:\n - alertname = OSPF State\n - _start = 2025-03-11 15:33:10.007854055 +0000 UTC\n - _stop = 2025-03-11 21:33:10.007854055 +0000 UTC\n - device_name = router-1\n - grafana_folder = Services\nAnnotations:\n - description = There is an issue with ospf for router-1\n - grafana_state_reason = MissingSeries\n - summary = OSPF Neighbour Down\nSource: http://localhost:3000/alerting/grafana/befj04oth58n4b/view?orgId=1\nSilence: http://localhost:3000/alerting/silence/new?alertmanager=grafana&matcher=_start%3D2025-03-11+15%3A33%3A10.007854055+%2B0000+UTC&matcher=_stop%3D2025-03-11+21%3A33%3A10.007854055+%2B0000+UTC&matcher=alertname%3DOSPF+State&matcher=device_name%3Drouter-1&matcher=grafana_folder%3DServices&orgId=1\nDashboard: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1\nPanel: http://localhost:3000/d/eee9jajpxup6ob3?orgId=1&viewPanel=4\n'
